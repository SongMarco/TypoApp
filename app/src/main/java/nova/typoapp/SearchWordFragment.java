...
import nova.typoapp.newsfeed.SearchFeedAdapter;
...
public class SearchWordFragment extends Fragment {
    ...
    public void updateRecyclerViewSearchWord() {
    ...
    SearchFeedAdapter searchFeedAdapter = new SearchFeedAdapter(SearchFeedContent.ITEMS_SEARCH);
    ...
    @BindView(R.id.recyclerViewSearchWord)
    RecyclerView recyclerViewSearchWord;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_searchword_list, container, false);
