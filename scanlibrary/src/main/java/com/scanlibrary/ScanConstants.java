...
public class ScanConstants {
    ...
    // provider_paths 값을 참고하라 ( res\xml\provider_paths.xml )
    // external-path 값의 child 여야 정상적으로 fileProvider 가 동작한다. - 경로가 맞지 않으면 illegalArgumentException
    public final static String PATH_SCANNED_IMG = Environment
            .getExternalStorageDirectory().getPath() + "/Pictures/TypoApp/scanImg";
